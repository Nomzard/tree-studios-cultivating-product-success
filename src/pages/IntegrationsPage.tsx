    ...
    <div className="overflow-hidden bg-secondary">
      ...
      <section className="relative">
        ...
        <div className="container mx-auto px-6 py-10 md:py-14">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
            {integrations.map((integration, i) => (
              <FadeIn key={i} delay={i * 0.1}>
                ...
                >
                  <div className="bg-card border border-border rounded-[1.5rem] p-8 h-full hover:border-terracotta/30 hover:-translate-y-1 transition-all duration-300">
                    <div
                    ...
                    <h2 className="text-2xl font-heading font-semibold text-foreground mb-3 group-hover:text-terracotta transition-colors">
                      {integration.name}
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-5">
                      {integration.desc}
                    </p>
                    <span className="inline-flex items-center gap-2 text-terracotta font-medium text-sm">
                      Learn more
          ...
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center bg-card border border-border rounded-[1.5rem] p-8">
