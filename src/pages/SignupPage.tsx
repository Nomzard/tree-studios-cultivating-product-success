                ...
                <div className="bg-card border border-border rounded-[1.5rem] p-8">
                  <div className="text-center space-y-6">
                    ...
                    <a
                      ...
                      className="w-full bg-terracotta text-white px-7 py-3.5 rounded-full font-medium hover:opacity-90 transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3"
                    >
